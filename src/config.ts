...
export const siteConfig: SiteConfig = {
	title: "Mizuki",
	subtitle: "欢迎来到baimu的小窝",
	siteURL: "https://yizhibaimu.dpdns.org/", // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "1779630773", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1779630773",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			...
			url: "https://github.com/yizhibaimu666",
		},
		{
			name: "Discord",
			icon: "fa7-brands:discord",
			url: "https://discord.gg/Sdwzcg9B3F",
		},
	],
};
